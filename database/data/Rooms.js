...
for (let i = 1; i < 101; i += 1) {
  rooms.push({
    ...
    rooms: faker.random.number({ min: 1, max: 100 }),
    bed: faker.random.number({ min: 1, max: 100 }),
    bath: faker.random.number({ min: 1, max: 100 }),
    guest: faker.random.number({ min: 1, max: 100 }),
    hostReviews: faker.random.number({ min: 1, max: 100 }),
